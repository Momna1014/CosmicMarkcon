...
interface SavedCardSkeletonProps {
  showSaveIcon?: boolean;
}

const SavedCardSkeleton: React.FC<SavedCardSkeletonProps> = memo(({ 
  showSaveIcon: _showSaveIcon = true 
}) => {
  return (
...
SavedCardSkeleton.displayName = 'SavedCardSkeleton';
