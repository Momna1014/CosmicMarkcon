/**
 * LoveLoader - Reusable full-screen loader component for Love Match
 *
 * Features:
 ...
 *
 * Usage:
 * <LoveLoader visible={isLoading} />
 * <LoveLoader visible={isLoading} text="Loading your chart..." />
 */
...
const LoaderAnimation = require('../../assets/lottie/FILLER.json');

interface LoveLoaderProps {
...
const LoveLoader: React.FC<LoveLoaderProps> = memo(
  ({visible, text, inline = false, size = moderateScale(180)}) => {
    if (!visible) {
      return null;
    }
