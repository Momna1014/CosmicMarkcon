...
// class AppsFlyerService {
  ...
  // async initialize(config: AppsFlyerConfig): Promise<void> {
    // if (!this.consentGranted) {
      // console.warn('[AppsFlyer] Consent not granted, skipping init');
      // return;
    // }
  ...
  // logEvent(eventName: string, eventValues?: Record<string, any>): void {
    // if (!this.consentGranted) {
      // console.warn('[AppsFlyer] Consent not granted, skipping event');
      // return;
    // }
  ...
  // setCustomerUserId(userId: string): void {
    // if (!this.consentGranted) {
      // console.warn('[AppsFlyer] Consent not granted, skipping user ID');
      // return;
    // }
  ...
  // setAdditionalData(data: Record<string, any>): void {
    // if (!this.consentGranted) {
      // console.warn('[AppsFlyer] Consent not granted, skipping additional data');
      // return;
    // }
  ...
  // setUserEmails(emails: string[], emailsCryptType: number = 0): void {
    // if (!this.consentGranted) {
      // console.warn('[AppsFlyer] Consent not granted, skipping user emails');
      // return;
    // }
  ...
  // async getAppsFlyerId(): Promise<string> {
    // if (!this.consentGranted) {
      // console.warn('[AppsFlyer] Consent not granted, skipping ID fetch');
      // return '';
    // }
  ...
  // /**
   // * Set consent status for AppsFlyer tracking
   // */
  // setConsentGranted(consentGranted: boolean): void {
    // this.consentGranted = consentGranted;
    // if (!consentGranted && this.isInitialized) {
      // this.setOptOut(true);
      // this.stop(true);
    // }
  // }
