/**
 * OnboardingScreen11 - Energetic Signature Screen
 *
 * Shows the unique energetic signature message with quote
 * "We've locked onto your unique energetic signature"
 */
...
const BackgroundImageSource = require('../../assets/icons/onboarding_icons/purple_background.png');
...
const STARS_CONFIG = [
  ...
  {size: 5, top: SCREEN_HEIGHT * 0.75, left: SCREEN_WIDTH * 0.2, delay: 300, intensity: 'medium' as const},
